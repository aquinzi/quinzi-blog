...
CONTENT_FOOTER = '''
    <div id="vcard" class="vcard author p-author h-card vcard">
        <p>Hi, <i class="icon-user"></i> <a href="http://quinzi.com.ar/" class="u-url url fn p-name" rel="me" itemprop="name url">{author}</a> over here. Sadly, you reached the end of the page. Why don't you go back to top and forget you came here? I won't say anything.<span><a href="#top"><i class="fa fa-chevron-circle-up"></i></a></span>
        </p>
    </div>
'''
